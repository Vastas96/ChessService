...
GameType = GraphQL::ObjectType.define do
  ...
  field :id, !types.Int
  field :white, -> { Types::PlayerType }, property: :white
  field :black, -> { Types::PlayerType }, property: :black

  field :post, -> { Types::PostType }, property: :post
  field :comments, -> { types[Type::CommentType] }, property: :comments
end